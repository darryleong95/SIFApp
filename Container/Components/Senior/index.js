...
export default class SeniorProfileComponent extends Component {
      ...
      <Container style={styles.main}>
        ...
        <Footer style={styles.footer}>
          <View style={{flex:1, flexDirection:"row"}}>
            ...
            <View>
              <TouchableOpacity style={styles.footerContainer} onPress={()=>this.props.navigation.navigate("DateComponent")}>
